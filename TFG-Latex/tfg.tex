...
\newcommand{\miTitulo}{Combinando distintas técnicas para el diseño de una metahehurística para problemas de optimización de alta densidad \xspace}
\newcommand{\miNombre}{Jesús García León\xspace}
\newcommand{\miGrado}{Doble Grado en Ingeniería Informáticva y Matemáticas}
\newcommand{\miFacultad}{Escuela Técnica Superior de Ingeniería Informatica y de Telecomunicación y Facultad de Ciencias}
...
\input{preliminares/presupuesto}              
...
\input{capitulos/optimizacion}
\input{capitulos/grouping}
\input{capitulos/lsgo}
\input{capitulos/tests}
...
\input{capitulos/metaheuristicas}
\input{capitulos/algoritmos}
